...
def stats(update, context):
    ...
    stats = f'<b>📅 Commit Date:</b> {last_commit}\n\n'\
            ...
            f'<b>🔷 Used:</b> {used} | <b>🆓 </b> {free}\n\n'\
            f'<b>⬆️ Upload:</b> {sent}\n'\
            f'<b>⬇️ Download:</b> {recv}\n\n'\
...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("💠 Ace Updates 💠", "https://telegram.me/Ace_ML")
    buttons.buildbutton("⚡ Mirror & Leech ☁️", "https://t.me/+e4zYNIuinzA0ZGE1")
...
'''
        ...
        sendMarkup('☹️ Sorry, Access Denied 🚫', context.bot, update.message, reply_markup)
